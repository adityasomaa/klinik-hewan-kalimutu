 ...
 *   1. Tidak pernah muncul di atas menu mobile. Skala z-index memang menaruh
 *      banner di atas menu, jadi yang dilakukan bukan menurunkan z-index-nya,
 *      melainkan menyembunyikan banner selama ada overlay terbuka.
...
export function CookieBanner() {
  ...
  /* Sembunyikan selama menu mobile, kalender, atau modal terbuka. */
  useEffect(() => {
    const sync = () =>
      setOverlayOpen(document.documentElement.hasAttribute("data-overlay-open"));
    sync();
  ...
  useEffect(() => {
    const visible = show && !overlayOpen;
